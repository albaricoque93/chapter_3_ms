...
%We used the timeseries described previously to perform invasion simulations of both alleles. Each allele can invade via two different pathways: males and females. For each timestep in
