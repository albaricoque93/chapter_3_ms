...
The overall average effect of fluctuations, $\delta^{0}$, was at first glance unpredictable when fluctuations were incorporated. Without fluctuations, $\delta^{0}$ captured exclusively the effect of selection and had positive values in parts of the parameter space where each allele could invade (Fig.~\ref{fig:ratios}). However, when we incorporated fluctuations, it also captured unexpected variance not captured by the terms in Table \ref{tab:EllnerRs}. Fluctuations in population sizes generated stochastic changes of $\delta^{0}$ accross the parameter space and spanned a greater extent when alleles invade via their non-favored pathway (Fig.~\ref{fig:ratios}). Fluctuations in selection generated $\delta^{0}$ values to  decrease in magnitude compared to the control simulation, which was heightened in parts of the parameter space that were on the limit of the coexistence region (Fig.~\ref{fig:ratios}). When we incorporated both types of fluctuations, the value of $\delta^{0}$ was more likely to changed compared to the control simulation (Fig.~\ref{fig:ratios}).
...
The results  of our study provide supporting evidence that environmental fluctuations can increase the expected genetic variation maintained under sexually antagonistic selection. Antagonistically selected alleles are an important component of genetic variation for many species \citep{foerster2007sexually,van2009intralocus,bonduriansky2009intralocus,innocenti2010sexually}. Furthermore, as much as $20\%$ of traits for which data is available are thought to be under sexually antagonistic selection \citep{morrissey2016meta}. Yet, a large body of work suggests that the criteria for maintaining antagonistic genetic variation is very restrictive (i.e., we would expect the coexistence of alleles in few scenarios) \citep{kidwell1977regions,pamilo1979genic,hedrick1999antagonistic,curtsinger1994antagonistic, patten2010fitness}. Our study shows that incorporating more relaistic assumptions, such as non-constant selection and population sizes can more than double the expected genetic variation under sexuallly antagonistic selection (Fig.~\ref{fig:heatmap}).

\subsubsection*{The relative contribution of fluctuations in selection}


Our results show that fluctuations in selection can promote allelic coexistence in parts of the parameter space where we would typically expect selection to fix one of the alleles (Fig.~\ref{fig:outcomes}). Fluctuating selection  promoted coexistence by contributing possitvely to an allele's  invasion growth rate when that allele was shielded from the fluctuations (Fig.~\ref{fig:boxes_selection}). Therefore, the relative contribution of both $w_{jm}$ and $w_{kf}$ fluctuating only promoted coexistence when fluctuations were positively correlated (Fig.~\ref{fig:boxes_selection}), which is why the average proportion of coexistence was generally higher for simulations that had this correlation (Fig.~\ref{fig:heatmap}). This 


In this paragraph we highlight our results that show that fluctuations in selection help an allele invade when it is shielded from the fluctuating selection. This could be understood as a relative non linearity to resources as \citep{shoemaker2020} also found. Give an example on how this could enhance coexistence when we would tipically not expect it to, for example in instances where the allele with the highest fitness also experiences more fluctuations, and how correlations could further enhance that.


In natural populations, fitness optima are higly variable as biotic and abiotic conditions are constantly changing \citep{siepielski2017precipitation}.

Selection may vary in space or time as aresult of variation in female preferences

Males and females often have dinstinct  roles in reproduction, social interactions or the ways they interact with the environment. These different niche and roles give rise to sexually antagonistic selection, such selection that often favors larger body syzes in females than in males due to a significant female fecundity advantage of large size, and sex differences in selection on feeding morphology as a consequence of sex specific nutritional requirenments.


Chippindale and collagues observed genotypes

In this paragraph we continue by contextualizing our findings with other studies that show that fluctuations in selection can promote polymorphism in sex-linked traits, or when generations overlap, which could be understood as a storage effect. Also mention \citep{connallon2018environmental} who found that selection coupled with life history traits promote polymorphism.

\subsubsection*{The effect of fluctuations in populatin sizes}
...
In this paragraph we contextualize how other findings have highlighted the importance of fluctuations in males and females to promote genetic diversity of sex-linked traits or by mitigating genetic drift. Mention how our findings fall into the existing understanding of non constant populations
